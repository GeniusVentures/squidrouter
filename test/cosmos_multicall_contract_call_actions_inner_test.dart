...
// tests for CosmosMulticallContractCallActionsInner
void main() {
  // final instance = CosmosMulticallContractCallActionsInner();

  group('test CosmosMulticallContractCallActionsInner', () {
