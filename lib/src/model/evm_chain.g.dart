...
part of 'evm_chain.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$EvmChain extends EvmChain {
  @override
  final EvmChainAllOfGas? gas;
  @override
  final EvmChainAllOfChainNativeContracts? chainNativeContracts;
  @override
  final String id;
  @override
  ...
  factory _$EvmChain([void Function(EvmChainBuilder)? updates]) =>
      (EvmChainBuilder()..update(updates))._build();
  ...
  _$EvmChain._(
      ...
      : super._();
  @override
  EvmChain rebuild(void Function(EvmChainBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EvmChainBuilder toBuilder() => EvmChainBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EvmChain &&
        gas == other.gas &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EvmChain')
          ..add('gas', gas)
...
class EvmChainBuilder
    implements Builder<EvmChain, EvmChainBuilder>, BaseChainBuilder {
  _$EvmChain? _$v;

  EvmChainAllOfGasBuilder? _gas;
  EvmChainAllOfGasBuilder get gas => _$this._gas ??= EvmChainAllOfGasBuilder();
  set gas(covariant EvmChainAllOfGasBuilder? gas) => _$this._gas = gas;

  EvmChainAllOfChainNativeContractsBuilder? _chainNativeContracts;
  EvmChainAllOfChainNativeContractsBuilder get chainNativeContracts =>
      _$this._chainNativeContracts ??=
          EvmChainAllOfChainNativeContractsBuilder();
  set chainNativeContracts(
          covariant EvmChainAllOfChainNativeContractsBuilder?
  ...
  EvmChainBuilder() {
    EvmChain._defaults(this);
  }

  EvmChainBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _gas = $v.gas?.toBuilder();
      _chainNativeContracts = $v.chainNativeContracts?.toBuilder();
      _id = $v.id;
      _chainId = $v.chainId;
      _type = $v.type;
  ...
  @override
  void replace(covariant EvmChain other) {
    _$v = other as _$EvmChain;
  }

  @override
  void update(void Function(EvmChainBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  EvmChain build() => _build();
  ...
  _$EvmChain _build() {
    ...
    try {
      ...
      try {
        _$failedField = 'gas';
        _gas?.build();
        _$failedField = 'chainNativeContracts';
        _chainNativeContracts?.build();
        ...
        throw BuiltValueNestedFieldError(
            r'EvmChain', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
