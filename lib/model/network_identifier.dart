...
class NetworkIdentifier {
  ...
  const NetworkIdentifier._(this.value);
  ...
  static List<NetworkIdentifier> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NetworkIdentifier>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NetworkIdentifier.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [NetworkIdentifier] to String,
/// and [decode] dynamic data back to [NetworkIdentifier].
class NetworkIdentifierTypeTransformer {
  factory NetworkIdentifierTypeTransformer() => _instance ??= const NetworkIdentifierTypeTransformer._();

  const NetworkIdentifierTypeTransformer._();

  String encode(NetworkIdentifier data) => data.value;

  /// Decodes a [dynamic value][data] to a NetworkIdentifier.
  ///
  ...
  /// Singleton [NetworkIdentifierTypeTransformer] instance.
  static NetworkIdentifierTypeTransformer? _instance;
}
