...
class TransactionStatus {
  ...
  int get hashCode =>
    ...
    (callEventLog == null ? 0 : callEventLog!.hashCode) +
    (chainData == null ? 0 : chainData!.hashCode) +
    (transactionUrl == null ? 0 : transactionUrl!.hashCode);

  @override
  String toString() => 'TransactionStatus[transactionId=$transactionId, blockNumber=$blockNumber, callEventStatus=$callEventStatus, callEventLog=$callEventLog, chainData=$chainData, transactionUrl=$transactionUrl]';
  ...
  static TransactionStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TransactionStatus(
        ...
        callEventLog: Object.listFromJson(json[r'callEventLog']),
        chainData: ChainData.fromJson(json[r'chainData']),
