...
class QuoteActionData {
  /// Returns a new [QuoteActionData] instance.
  QuoteActionData({
  ...
  List<SwapDetailsOsmosisPoolsInner> osmosisPools;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is QuoteActionData &&
    other.target == target &&
  ...
  /// Returns a new [QuoteActionData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static QuoteActionData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "QuoteActionData[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "QuoteActionData[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return QuoteActionData(
        ...
        osmosisPools: SwapDetailsOsmosisPoolsInner.listFromJson(json[r'osmosisPools']),
  ...
  static List<QuoteActionData> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <QuoteActionData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = QuoteActionData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, QuoteActionData> mapFromJson(dynamic json) {
    final map = <String, QuoteActionData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = QuoteActionData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of QuoteActionData-objects as value to a dart map
  static Map<String, List<QuoteActionData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<QuoteActionData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = QuoteActionData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
